...
class BinaryTree
{
    ...
    private:
        ...
        /**
         * Private helper fucntion for the public mirror function.
         */
        ...
        /**
         * Private helper function to find the left-most element.
         */
        T leftMost(const Node* subRoot) const;

        /**
         *  Private helper function to find the right-most element.
         */
